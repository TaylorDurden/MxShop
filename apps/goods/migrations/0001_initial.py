...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '大图轮播商品图片',
                'verbose_name_plural': '大图轮播商品图片',
            },
        ),
        migrations.CreateModel(
            name='Goods',
            fields=[
                ...
                ('goods_brief', models.TextField(default=0, max_length=300, verbose_name='商品简述')),
                ('goods_desc', DjangoUeditor.models.UEditorField(default='', verbose_name='内容')),
                ('ship_free', models.BooleanField(default=True, verbose_name='是否承担运费')),
                ('goods_front_image', models.ImageField(blank=True, max_length=200, null=True, upload_to='', verbose_name='封面图片')),
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(blank=True, help_text='品牌名', null=True, on_delete=django.db.models.deletion.CASCADE, to='goods.GoodsCategory', verbose_name='商品分类'),
        ),
        migrations.AddField(
            model_name='banner',
            name='goods',
