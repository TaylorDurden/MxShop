...
class UserLeaveMessage(models.Model):
    ...
    user = models.ForeignKey(User, verbose_name=u"用户")
    message_type = models.IntegerField(default=1, choices=MESSAGE_CHOICES, verbose_name=u"留言类型")
    ...
    file = models.FileField(upload_to="", verbose_name=u"上传的文件", help_text=u"上传的文件")
    add_time = models.DateTimeField(default=datetime.now, verbose_name=u"添加时间")
